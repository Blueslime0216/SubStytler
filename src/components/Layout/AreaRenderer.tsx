...
export const AreaRenderer: React.FC<AreaRendererProps> = ({ areas, setAreas }) => {
  ...
  return (
    <div ref={containerRef} className="area-layout-container" style={{ position: 'relative', width: '100%', height: '100%' }}>
      {areas.map(area => (
        <div
          key={area.id}
        ...
        >
          ...
          <div
            ...
            style={{ left: 0, top: 0, width: BORDER_THICKNESS, height: '100%', position: 'absolute', cursor: 'ew-resize', zIndex: 10 }}
            onMouseDown={e => onBorderMouseDown(e, area.id, 'left')}
          />
          {/* 우 */}
          <div
            className="area-border area-border-vertical"
            style={{ right: 0, top: 0, width: BORDER_THICKNESS, height: '100%', position: 'absolute', cursor: 'ew-resize', zIndex: 10 }}
            onMouseDown={e => onBorderMouseDown(e, area.id, 'right')}
          />
          {/* 상 */}
          <div
            className="area-border area-border-horizontal"
            style={{ left: 0, top: 0, width: '100%', height: BORDER_THICKNESS, position: 'absolute', cursor: 'ns-resize', zIndex: 10 }}
            onMouseDown={e => onBorderMouseDown(e, area.id, 'top')}
          />
          {/* 하 */}
          <div
            className="area-border area-border-horizontal"
            style={{ left: 0, bottom: 0, width: '100%', height: BORDER_THICKNESS, position: 'absolute', cursor: 'ns-resize', zIndex: 10 }}

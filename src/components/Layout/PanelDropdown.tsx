    ...
    <Portal>
      ...
      <AnimatePresence>
        <motion.div
          ...
          className="dropdown-cinematic fixed z-50 overflow-hidden"
          style={{
            top: position.top,
            left: position.left,
            width: '380px'
        ...
        >
          <div className="p-6">
            <div className="caption-cinematic font-semibold px-3 py-3 mb-4 text-cinematic-gold">
              Switch Panel Type
            </div>
              ...
              {availablePanels.map(([panelType, panelConfig]) => {
                ...
                return (
                  <motion.button
                    ...
                    className="dropdown-item-cinematic w-full flex items-center space-x-5 p-5 text-left"
                  >
                    <motion.div 
                      className="p-3 rounded-xl bg-cinematic-gold border-2 border-cinematic-gold shadow-cinematic-gold"
                      whileHover={{ rotate: 5 }}
                    >
                      <PanelIcon className="w-6 h-6 text-black" />
                    </motion.div>
                    <div className="flex-1 min-w-0">
                      <div className="body-cinematic-primary font-semibold text-cinematic-gold">
                        {panelConfig.title}
                      </div>
                      <div className="caption-cinematic truncate">
                        {panelConfig.description}
                      </div>
                    </div>
                    <motion.svg 
                      className="w-5 h-5 text-cinematic-silver opacity-0 group-hover:opacity-100"
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24"
                      whileHover={{ x: 6 }}

  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <motion.div
        ...
        className="relative bg-surface border border-border-color rounded-lg shadow-outset-strong max-w-md w-full mx-4 overflow-hidden"
      >
        {/* Header */}
        <div className="flex items-center justify-between p-5 border-b border-border-color bg-base-color">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-warning-color rounded-lg flex items-center justify-center shadow-outset">
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="bg-base-color rounded-lg p-4 shadow-inset-subtle">
            ...
            {/* Progress Bar */}
            <div className="h-2 bg-surface rounded-full shadow-inset-subtle overflow-hidden">
              <div 
                className="h-full bg-warning-color"
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={index} className="flex items-start gap-2 text-sm">
                  <item.icon className="w-4 h-4 text-warning-color mt-0.5 flex-shrink-0" />
          ...
          {/* Recommendations */}
          <div className="bg-success-color/10 border border-success-color/20 rounded-lg p-4">
            <h3 className="text-sm font-medium text-success-color mb-2 flex items-center gap-2">
        ...
        {/* Footer */}
        <div className="flex items-center justify-between p-5 border-t border-border-color bg-base-color/50">
          <button
            onClick={onClose}
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={onConfirm}
              className="btn px-6 py-2 bg-warning-color text-white border-warning-color hover:bg-warning-color/90"
            >
              Continue Anyway
            </button>
          </div>
